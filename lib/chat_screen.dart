  ...
  Future<void> _sendMessage() async {
    ...
    try {
      await supabase.from('messages').insert({
        ...
        'content': text, // اذا عمودك اسمه content
        // 'message': text, // اذا عمودك اسمه message امسح السطر الفوك وفعل هذا
        'topic': 'general', // حقل اجباري عندك
        'extension': 'txt', // حقل اجباري عندك
      });
      _scrollToBottom();
    } catch (e) {
      print('Error: $e');
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      // نجيب بيانات المرسل بـ FutureBuilder منفصل
                      return FutureBuilder<Map<String, dynamic>?>(
                        ...
                        builder: (context, profileSnap) {
                          ...
                          final msg = MessageModel(
                            ...
                            userId: msgData['user_id']?.toString()?? '',
